...
class UtilsApi {
  ...
  async addProductImage(file) {
    try {
      const res = await axios.post(`${this.URI}/product/productImage`, {
        file,
      });
  ...
  async removeProductImage(file) {
    try {
      const res = await axios.delete(
        `${this.URI}/product/productImage?id=${file.id}`
      );
  ...
  async setPaymentId(orderId, pid) {
    try {
      const res = await axios.put(`${this.URI}/updatePaymentId`, {
        orderId,
        pid,
      });
      return res;
  ...
  async getPaymentIntent(data) {
    try {
      const res = await axios.post(`/api/checkout/getClientIntent`, {
        items: data,
      });
  ...
  async checkoutSquarePayment(data) {
    try {
      const res = await axios.post(`/api/checkout/squarecharge`, {
        items: data,
      });
      return { success: true, ...res.data };
    } catch (e) {
  ...
  async getEstimations(data) {
    try {
      const res = await axios.post(`${this.URI}/getEstimations`, {
        items: data,
      });
      return { ...res.data };
    } catch (e) {
  ...
  async requestUPS(data) {
    try {
      const res = await axios.post(`${this.URI}/requestShipping`, {
        items: data,
      });
      return { ...res.data };
    } catch (e) {
